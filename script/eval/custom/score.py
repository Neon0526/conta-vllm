...
with open('/home/new/桌面/bunny/Bunny/script/eval/custom/epoch10/conta/predict_new_conta.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
for item in data:
    ...
    actual_answer_tokens = actual_answer.split()
